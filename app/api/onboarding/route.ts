...
export async function POST(request: Request) {
  ...
  if (cliente) {
    const promptSistema = montarPromptSistema({
      ...
      enderecoLocalizacao: parsed.data.endereco_localizacao ?? null,
      ...
      comoFuncionaAtendimento: parsed.data.como_funciona_atendimento ?? null,
      quandoTransferirHumano: parsed.data.quando_transferir_humano ?? null,
      contatoEquipeHumana: parsed.data.contato_equipe_humana ?? null,
      restricoes: parsed.data.restricoes ?? null,
      ...
      .upsert(
        {
          ...
          como_funciona_atendimento: parsed.data.como_funciona_atendimento ?? null,
